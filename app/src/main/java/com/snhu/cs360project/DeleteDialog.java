...
public class DeleteDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(R.string.del_ask)
                .setPositiveButton(R.string.del_yes, (dialog, id) -> {
                    // Send the positive button event back to the host activity
                    listener.onDialogPositiveClick(DeleteDialog.this);
                })
                .setNegativeButton(R.string.del_no, (dialog, id) -> {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            ...
            listener = (DeleteDialogListener) correctFrag;
